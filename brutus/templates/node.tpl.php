...
/**
 * @file
 * Brutus theme implementation to display a node.
 *
 * Available variables:
 ...
 */
?>
<article role ="article" id="article-node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <section class="content clearfix"<?php print $content_attributes; ?>>
    <?php
